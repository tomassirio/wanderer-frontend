...
/// Discover section embedded in the guest (logged-out) hero layout —
/// same promoted/non-promoted trip split as [DiscoverTabContent], but
/// without a RefreshIndicator/ListView wrapper since it's not its own tab.
class GuestDiscoverSection extends ConsumerWidget {
  final ValueChanged<Trip> onTripTap;
  final ValueChanged<Trip> onDeleteTrip;

  const GuestDiscoverSection({
    super.key,
